...
const char MainPage[] PROGMEM = R"=====(
  ...
  <html>
   <head> 
       <title>Điện Tử - Viễn Thông KMA</title> 
       <style> 
   ...
   <body> 
      <div><h1>Điện Tử - Viễn Thông KMA</h1></div>
      <div id="content"> 
        ...
        <div id="wifisetup" style="height:340px; font-size:20px; display:none";>
          ...
          <div><input class="button_setup" type="button" onclick="HOME()" value="Back home"/></div>
          <div id="reponsetext"></div>
        </div>
        <div><input id="ledconnect" type="button"/>Connection status</div>
      </div>
      <div id="footer">
        <p><i>Đề tài khoa học KMA </i>
        </p>
      </div>
      <script>
